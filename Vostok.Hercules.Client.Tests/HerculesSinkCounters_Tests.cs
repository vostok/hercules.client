...
namespace Vostok.Hercules.Client.Tests
{
    ...
    internal class HerculesSinkCounters_Tests
    {
        ...
        {
            var counters = new HerculesSinkCounters((5, 151), (3, 134), (1, 18), 1, 2, 13, 1);
        ...
        {
            var counters1 = new HerculesSinkCounters((5, 151), (3, 134), (1, 18), 100, 2, 13, 1);
            var counters2 = new HerculesSinkCounters((8, 235), (1, 54), (10, 180), 200, 5, 1, 40);
